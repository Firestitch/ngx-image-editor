...
import { FsImageEditorService } from '../../services/fs-image-editor.service';
import { ISettings } from '../../interfaces/';
import { ModeList, EditorConfig } from '../../models/';

@Component({
  selector: 'fs-image-editor',
  templateUrl: 'fs-image-editor.component.html',
  styleUrls: [ 'fs-image-editor.component.scss' ],
})
